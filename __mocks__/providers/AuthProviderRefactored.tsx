...
const mockAuthContextValue = {
  ...
  refreshRoles: jest.fn().mockResolvedValue(['user', 'advertiser', 'publisher', 'admin', 'stakeholder']),
  getUserRoles: jest.fn().mockReturnValue(['user', 'advertiser', 'publisher', 'admin', 'stakeholder']),
  hasRole: jest.fn().mockImplementation((role) => ['user', 'advertiser', 'publisher', 'admin', 'stakeholder'].includes(role)),
