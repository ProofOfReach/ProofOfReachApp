...
.catch(error => console.log("Error:", error));`}
                              ...
                              {Object.entries(endpoint.responses).map(([code, response]: [UserRole, any], respIndex: number) => (
                                <div key={respIndex} className="bg-gray-700 rounded-lg p-4">
                                  ...
                                  {response.content && response.content['application/json'] && response.content['application/json'].schema && (
                                    <div className="mt-3">
                                      <h4 className="text-sm text-gray-400 mb-2">Response Schema</h4>
                                  ...
                                  {response.content && response.content['application/json'] && response.content['application/json'].schema && (
                                    <div className="mt-3">
                                      <h4 className="text-sm text-gray-400 mb-2">Example Response</h4>
                                      <pre className="text-sm text-gray-300 overflow-x-auto bg-gray-800 p-3 rounded">
                                        <div dangerouslySetInnerHTML={{ 
                                          __html: syntaxHighlight(JSON.stringify(generateExampleValue(response.content['application/json'].schema), null, 2))
                                        }} />
                                      </pre>
                                    </div>
                                  )}
          ...
          {activeSection === 'schemas' && spec.components && spec.components.schemas && (
            <div>
          ...
          {activeSection === 'raw' && (
            <div>
              ...
              <div className="bg-gray-800 rounded-lg p-4 max-w-full">
                <pre className="text-sm text-gray-300 overflow-x-auto">
                  <div dangerouslySetInnerHTML={{ 
