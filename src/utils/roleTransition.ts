  ...
  try {
    ...
    if (targetPath) {
      ...
      try {
        ...
        logger.log('Error during Next.js router navigation:', routerError);
    ...
    logger.log('Error during role transition:', error);
    clearRoleTransitionState();
    return false;
  }
}
...
export function setRoleTransitionState(state: RoleTransitionState): void {
  ...
  try {
    ...
    logger.log('Error setting role transition state:', error);
  }
}
...
export function updateRoleTransitionState(partialState: Partial<RoleTransitionState>): void {
  ...
  try {
    ...
    logger.log('Error updating role transition state:', error);
  }
}
...
export function getRoleTransitionState(): RoleTransitionState | null {
  ...
  try {
    ...
    logger.log('Error getting role transition state:', error);
  }
...
export function clearRoleTransitionState(): void {
  ...
  try {
    ...
    logger.log('Error clearing role transition state:', error);
  }
}
...
export function completeRoleTransition(): void {
  ...
  try {
    ...
    logger.log('Error completing role transition:', error);
  }
}
 ...
 */
export function saveRolePreferences(role: UserRole, preferences: Record<UserRole, any>): void {
  if (typeof window === 'undefined') {
    return;
  }
  ...
  try {
    ...
    logger.log('Error saving role preferences:', error);
  }
}
 ...
 */
export function getRolePreferences(role: string): Record<UserRole, any> {
  if (typeof window === 'undefined') {
    return {};
  }
  ...
  try {
    ...
    logger.log('Error getting role preferences:', error);
    return {};
  }
}
 ...
 */
export function getRolePreferencesForAllRoles(): Record<UserRole, Record<UserRole, any>> {
  if (typeof window === 'undefined') {
    return {} as Record<UserRole, Record<UserRole, any>>;
  }
  
  try {
    const preferencesJson = localStorage.getItem(ROLE_PREFERENCES_KEY);
    if (preferencesJson) {
      return JSON.parse(preferencesJson) as Record<UserRole, Record<UserRole, any>>;
    }
  } catch (error) {
    logger.log('Error getting all role preferences:', error);
  }
...
export function addRoleSwitchedListener(
  ...
  try {
    ...
    logger.log('Error setting up role switched listener:', error);
