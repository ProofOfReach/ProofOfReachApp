...
import DropdownSidebar from './DropdownSidebar'; // Import the dropdown sidebar
...
const DropdownDashboardLayout: React.FC<DashboardLayoutProps> = ({ children, title, role }) => {
  return (
...
export default DropdownDashboardLayout;