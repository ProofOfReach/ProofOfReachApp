...
export function resetAllAuthState(): void {
  ...
  try {
    ...
    logger.log('Error clearing localStorage:', error);
  }
  ...
  try {
    ...
    logger.log('Error clearing sessionStorage:', error);
  }
  ...
  try {
    ...
    logger.log('Error clearing cookies:', error);
  }
  ...
  try {
    ...
    logger.log('Error setting prevent_auto_login flag:', error);
  }
  ...
  try {
    ...
    logger.log('Error redirecting to login page:', error);
  }
}
