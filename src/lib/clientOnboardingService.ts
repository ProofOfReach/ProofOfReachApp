...
const clientOnboardingService = {
   ...
   */
  async getOnboardingStatus(pubkey: string, role: UserRole) {
    try {
   ...
   */
  async updateOnboardingProgress(pubkey: string, role: UserRole, data: any) {
    try {
   ...
   */
  async completeOnboarding(pubkey: string, role: UserRole) {
    try {
   ...
   */
  async resetOnboarding(pubkey: string, role: UserRole) {
    try {
