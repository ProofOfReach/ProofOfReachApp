...
const initializeMockLightning = async () => {
  ...
  try {
    ...
    console.log("Failed to initialize Mock Lightning service:", error);
...
const createMockInvoice = async (
  ...
  try {
    ...
    console.log("Failed to create mock invoice:", error);
...
const payMockInvoice = async (
  ...
  try {
    ...
    console.log("Failed to pay mock invoice:", error);
...
const initializeBreezSDK = async () => {
  ...
  try {
    ...
    if (!isTestMode()) {
      ...
      if (!apiKey) {
        console.log("BREEZ API key not available");
...
const createBreezInvoice = async (
  ...
  try {
    ...
    console.log("Failed to create BREEZ invoice:", error);
    throw new Error("Could not create Lightning invoice");
  }
};
...
const payBreezInvoice = async (
  ...
  try {
    ...
    console.log("Failed to pay BREEZ invoice:", error);
    throw new Error("Could not complete Lightning payment");
  }
};
...
export const simulateTestSatsPayment = async (
  ...
  try {
    ...
    console.log("Error in test payment simulation:", error);
...
export const getWebLNProvider = async () => {
  ...
  try {
    ...
    console.log("Failed to enable WebLN:", error);
