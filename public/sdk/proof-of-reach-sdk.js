      ...
      const testAds = [
        {
          ...
          imageUrl: options.testMode ? `${this.baseUrl}/sats_symbol_white.png` : 'https://example.com/ad1.jpg',
        ...
        },
        {
          ...
          imageUrl: options.testMode ? `${this.baseUrl}/sats_symbol_white.png` : 'https://example.com/ad2.jpg',
        ...
        },
        {
          ...
          imageUrl: options.testMode ? `${this.baseUrl}/sats_symbol_white.png` : 'https://example.com/ad3.jpg',
